...
public final class CompatMod {
    ...
    public CompatMod(IEventBus modEventBus, ModContainer modContainer) {
        ClientPreferences.register(modContainer);
        ServerPreferences.register(modContainer);
        // Payload types are registered through RegisterPayloadHandlersEvent
        // handlers annotated with @SubscribeEvent inside CompatNetwork.
        modEventBus.register(CompatNetwork.class);
